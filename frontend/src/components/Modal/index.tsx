    ...
    >
      ...
      >
        ...
        <div className="p-5 space-y-4 grid grid-cols-2 gap-x-5 gap-y-2 ">
          ...
          <Input label={"Dono"} placeholder={"Nome Sobrenome"} />

          <Input label={"Raça"} placeholder={"Raça"} />

          <Input label={"Telefone"} placeholder={"(00) 0 0000-0000"} />

          <Input label={"Nascimento"} type="Date" placeholder={"00/00/0000"} />
        </div>
        ...
        <div className="flex items-center gap-3 p-5">
          ...
          {type === "Edit" && (
            ...
            px-4 rounded-lg hover:bg-gray-100 transition-colors duration-200 flex items-center justify-center gap-2"
            >
